...
const Header: React.FC<HeaderProps> = ({
    ...
    return (
        <div className="flex h-full flex-col gap-1.5 h-full">
            ...
            <main className="h-full flex-1 overflow-y-auto bg-[#eee] rounded-3xl shadow-md p-6 border-2 border-indigo-500">
            {children}
            </main>
